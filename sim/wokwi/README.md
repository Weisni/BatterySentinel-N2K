...
The precompiled INA238 custom-chip WASM is tracked in `sim/wokwi/chips/ina238.chip.wasm`. It is rebuilt automatically by `.github/workflows/wokwi-chip.yml` whenever its source changes.
