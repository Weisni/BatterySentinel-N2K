...
// Default software alert limits. They are deliberately below the 500 A shunt rating.
// Tune during commissioning after measuring actual starter and bow-thruster currents.
